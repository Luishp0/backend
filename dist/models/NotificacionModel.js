...
const notificacionItemSchema = new mongoose_1.Schema({
...
const notificacionSchema = new mongoose_1.Schema({
    id_usuario: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'usuarios', required: true }, // Relación con usuarios
